...
import com.envyful.api.neoforge.command.command.ForgePlatformCommand;
import com.envyful.api.neoforge.command.command.sender.ConsoleSenderType;
import com.envyful.api.neoforge.command.command.sender.ForgePlayerSenderType;
import com.envyful.api.neoforge.command.command.sender.MessageableSenderType;
import com.envyful.api.neoforge.command.completion.number.IntegerTabCompleter;
import com.envyful.api.neoforge.command.completion.player.PlayerTabCompleter;
import com.envyful.api.neoforge.command.injector.ForgeFunctionInjector;
